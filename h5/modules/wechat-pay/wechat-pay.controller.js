...
(function () {
    ...
    WeChatPayController.$inject = ['$scope', '$http','$rootScope', '$window','$state', '$location', '$stateParams', 'WeixinService', 'API', 'ConfigModel'];

    function WeChatPayController($scope, $http,$rootScope, $window, $state, $location, $stateParams, WeixinService, API, ConfigModel) {
